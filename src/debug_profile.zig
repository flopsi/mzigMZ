...
pub fn main(init: std.process.Init) !void {
    ...
    if (argc >= 3) {
        const arg2 = argv_w[2][0..utf16ZLen(argv_w[2])];
        var arg2_ascii: [32]u8 = undefined;
        for (arg2, 0..) |ch, i| arg2_ascii[i] = @intCast(ch);
        scan_index = try std.fmt.parseInt(usize, arg2_ascii[0..arg2.len], 10);
    ...
    const num_points = profile.decodeFtProfile(packet_slice, calibrators, mz_buf, int_buf, use_subsegment) catch |err| {
